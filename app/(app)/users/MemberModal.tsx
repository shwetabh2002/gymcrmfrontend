            ...
            <div className={styles.fields}>
              <div className={styles.row}>
                <div className={styles.field}>
                  ...
                  <input className={styles.input} name="name" placeholder="John Doe"
              ...
              <div className={styles.row}>
                <div className={styles.field}>
                  ...
                  <input className={styles.input} name="phone" placeholder="+1234567890"
                    value={form.phone} onChange={handleChange} />
                </div>
                <div className={styles.field}>
                  <label className={styles.label}>Emergency Contact</label>
                  <input className={styles.input} name="emergencyContact" placeholder="+1987654321"
              ...
              <div className={styles.row}>
                <div className={styles.field}>
                  ...
                  <input className={styles.input} name="address" placeholder="123 Main St, New York"
                    value={form.address} onChange={handleChange} />
                </div>
                <div className={styles.field}>
                  <label className={styles.label}>Status</label>
                  <select className={styles.input} name="memberStatus"
                    value={form.memberStatus} onChange={handleChange}>
